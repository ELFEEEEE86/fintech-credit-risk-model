The original dataset and processed modeling files are not included in this repository due to file size limitations.
...
3. Run notebooks sequentially from:
   ...
   - through `05_project_summary.ipynb`

Processed datasets and trained artifacts are intentionally excluded from version control.